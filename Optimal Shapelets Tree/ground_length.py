...
def computeAll(H_true):
    ...
    for t in range(5):
        ...
        A_true = []
        count = 1
        probs = np.random.binomial(1, 5 / 6, branch_nodes)
        ...
        for t_b in range(5):
            ...
            #print(y)
            X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.90, random_state=1, shuffle=True, stratify=y)
            ...
            for H in H_values:
                ...
                for train_index, test_index in kf.split(X_train):
                    ...
                    model, branch_nodes, leaf_nodes, n, _ = generateModel(X_train_cv, y_train_cv, alpha, depth, H, epsilon, K=2, true_exemplar=exemplar)
            ...
            model, branch_nodes, leaf_nodes, n, _ = generateModel(X_train, y_train, alpha, depth, best_H, epsilon, K=2, true_exemplar=exemplar)
...
if __name__ == '__main__':
    ...
    df.to_csv('results_depth_3_parallel.csv', sep=',', index=False)
